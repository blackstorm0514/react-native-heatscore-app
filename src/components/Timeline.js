...
import { StyleSheet, FlatList, Image, View, Text, TouchableOpacity, I18nManager } from "react-native";
...
export default class Timeline extends PureComponent {
    constructor(props, context) {
        ...
        this.renderCircle = this.props.renderCircle
            ...
            : this._renderCircle
        this.renderEvent = this._renderEvent;
...
const styles = StyleSheet.create({
    ...
    detail: { paddingTop: 0, paddingBottom: 20 },
    description: {
        marginTop: 10
    },
    separator: {
